...
function writeUserData(selectedTxt, URL, lat, lng) {
  ...
  const newDescriptionPetRef = push(databaseRef(database, 'descriptionPet/'));

  // Gravar o texto e a URL da imagem
  set(newDescriptionPetRef, {
    text: selectedTxt,
    imageUrl: URL,
    user: userInfo.nome,
...
function handleButtonClick() {
  const descriptionInput = document.getElementById('description_input_pet').value;
