...
function writeUserData(selectedTxt, URL, lat, lng) {
  ...
  const newDescriptionEmpresaRef = push(databaseRef(database, 'descriptionEmpresa/'));

  // Gravar o texto e a URL da imagem
  set(newDescriptionEmpresaRef, {
    text: selectedTxt,
    imageUrl: URL,
    user: userInfo.nome,
...
function handleButtonClick() {
  const descriptionInput = document.getElementById('description_input_empresa').value;
